...
class dotwCell: UICollectionViewCell {
...
//        add the views to the content view
        ...
        bubbleWidthAnchor = cellView.widthAnchor.constraint(equalToConstant: 50)
...
//        add the text into the textView
        ...
        cellText.widthAnchor.constraint(equalToConstant: 50).isActive = true
